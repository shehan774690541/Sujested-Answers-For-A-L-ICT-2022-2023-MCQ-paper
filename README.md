...
<h2>First download and run this code</h2>

<h2>After that run it</h2>
<img src="images/1.png" alt="image not found" width="100%">

<h2>Your name will be asked, enter the name</h2>
...
<h2>After answering all 50 questions, your ICT paper marks will be displayed.</h2>
<img src="images/3.png" alt="image not found" width="100%">

<h2>Shows correct marks, incorrect marks and blank marks</h2>
<img src="images/4.png" alt="image not found" width="100%">

<h2>Finally it will show relief and press enter button to quit</h2>
<img src="images/5.png" alt="image not found" width="100%">

<h2>Your character set will be searched as a .txt file with your name</h2>
<img src="images/1.png" alt="image not found" width="100%">

<h2>Please protect the creator's rights. Finally, my YouTube channel opens as a web page</h2>
